...
if (isset($_POST['savebtn'])) {
    ...
    $query = "SELECT * FROM tbladmin WHERE email = '$UEmail'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $insert = "INSERT INTO tbladmin(adminid, fname, lname, email, pwd)
        ...
        try {
            ...
            if ($insert_result) {
                if (mysqli_affected_rows($conn) > 0) {
                    ...
                    echo '<script>window.location.assign("adlog.php");</script>';
                } else {
