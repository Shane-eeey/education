      ...
      <div class="container ">
        ...
        <div class="filter-form">
          <form action="grade1.php" method="get">
            ...
            <select name="filterGrade" onchange="this.form.submit()">
        ...
        <?php
          ...
          if ($result->num_rows > 0) {
              ...
              foreach ($modules as $category => $moduleDetails) {
                  if (!empty($moduleDetails)) {
                      echo '<div class="col-md-4 ">';
                      echo '<div class="box ">';
                      echo '<div class="detail-box">';
                      echo '<h5>' . $category . '</h5>';
                      echo '<p>' . $category . ' Modules</p>';

                      foreach ($moduleDetails as $moduleDetail) {
                          echo '<a href="uploads/' . $moduleDetail['pdfFile'] . '" target="_blank">' . $moduleDetail['moduleName'] . '</a><br>';
                      }
          ...
          <div class="col-md-4 ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <a href="English1.pdf">Module 1</a><br>
                <a href="English1.pdf">Module 2</a><br>
                <a href="English1.pdf">Module 3</a><br>
                <a href="English1.pdf">Module 4</a><br>
                </a>
              </div>
            </div>
          </div>
          <div class="col-md-4 ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <a href="English1.pdf">Module 1</a>
              </div>
            </div>
          </div>
          <div class="col-md-4 ">
